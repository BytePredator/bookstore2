<?php /* Smarty version 2.6.26, created on 2010-06-07 17:20:46
         compiled from ricerca_dettagli_registrato.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'ricerca_dettagli_registrato.tpl', 10, false),)), $this); ?>
             ...
             <form action="index.php" method="post">
              <fieldset><legend>&nbsp;VOTA LIBRO&nbsp;</legend>
                ...
                <p><label for="commento" class="left">Commento:</label>
                   ...
                   <input type="hidden" name="id_libro" value="<?php echo $this->_tpl_vars['dati']['ISBN']; ?>
" />
