<?php /* Smarty version 2.6.26, created on 2010-05-31 22:11:38
         compiled from carrello_registrato.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'carrello_registrato.tpl', 16, false),)), $this); ?>
...
" size="1" /></td>
            ...
            <tr><td colspan="5"><input id="button" type="submit" name="task" value="Svuota" /><input id="button" type="submit" name="task" value="Aggiorna Carrello" /><input type="hidden" name="controller" value="carrello" /></form>
