<?php /* Smarty version 2.6.26, created on 2010-05-31 22:06:39
         compiled from ordine_default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'ordine_default.tpl', 29, false),)), $this); ?>
...
?>
            <tr><th scope="row"><?php echo $this->_tpl_vars['carrello']['oggetti'][$this->_sections['i']['index']]['titolo']; ?>
                ...
                <td id="numero"><?php echo ((is_array($_tmp=$this->_tpl_vars['carrello']['oggetti'][$this->_sections['i']['index']]['subtotale'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</td></tr>
            <?php endfor; endif; ?>
