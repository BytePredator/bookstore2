<?php /* Smarty version 2.6.26, created on 2010-06-07 12:14:29
         compiled from ordine_carrello_registrato.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'ordine_carrello_registrato.tpl', 16, false),)), $this); ?>
...
" size="1" /></td>
                ...
                <?php $this->assign('sub', ($this->_tpl_vars['dati']['oggetti'][$this->_sections['i']['index']]['quantita']*$this->_tpl_vars['dati']['oggetti'][$this->_sections['i']['index']]['prezzo'])); ?>
            ...
            <tr><td colspan="3"></td><td colspan="2"><input id="button" type="submit" name="task" value="Svuota" /><input id="button" type="submit" name="task" value="Aggiorna Carrello" />
